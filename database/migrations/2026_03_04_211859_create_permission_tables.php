...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // skip during unit tests to avoid duplicate table creation
        // if (app()->runningUnitTests()) {
        //     return;
        // }

        // if tables already exist just bail out early
        if (Schema::hasTable($tableNames['permissions'])) {
            return;
        }

        throw_if(empty($tableNames), Exception::class, 'Error: config/permission.php not loaded.');
        throw_if($teams && empty($columnNames['team_foreign_key'] ?? null), Exception::class, 'Error: team_foreign_key missing.');
