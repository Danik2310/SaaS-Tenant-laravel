...
use App\Shared\Traits\AuditablePaymentMethods;
...
class PaymentMethodController extends Controller
{
    ...
    public function store(StorePaymentMethodRequest $request)
    {
        ...
        return response()->json(['message' => 'Payment method created', 'method' => new PaymentMethodResource($method)], 201);
    }
    ...
    {
        $method = Cache::remember("payment_method_{$id}", 3600, function () use ($id) {
